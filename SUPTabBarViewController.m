...
@interface SUPTabBarViewController ()
...
//    //self.bannerView.adUnitID = @"ca-app-pub-3940256099942544/6300978111"; //TEST AD BANNER
//    self.bannerView.adUnitID = @"ca-app-pub-8236497982755596/6825815073"; // Real ad unit id
