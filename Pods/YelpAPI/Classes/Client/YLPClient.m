...
+ (void)authorizeWithAppId:(NSString *)appId
    ...
    NSString *key = @"oN_pE1NBI7E5umFqaT4RJGmKVmIvk-v2qlnwMgb55GWc62w2MuI8h07LY1szB_iWwHXXK1n6vtESjCXRcv0T9dCUKX_8SWjhrHSE7NbUB2awtix6_gFEPJgu0ANxWHYx";

    YLPClient *client = [[YLPClient alloc] initWithAPIKey:key];
